...
# export CI_PROJECT_NAME="devopscorner-atlantis"
...
main() {
  # docker_build Dockerfile devopscorner/devopscorner-atlantis [alpine|ubuntu|codebuild] [version|latest|tags] [custom-tags]
