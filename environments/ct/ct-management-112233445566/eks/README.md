...
| <a name="input_dns_url"></a> [dns\_url](#input\_dns\_url) | n/a | `map(string)` | <pre>{<br/>  "lab": "atlantis-dci.devopscorner.id",<br/>  "nonprod": "atlantis-dci.devopscorner.id",<br/>  "prod": "atlantis-dci.devopscorner.id",<br/>  "staging": "atlantis-dci.devopscorner.id"<br/>}</pre> | no |
