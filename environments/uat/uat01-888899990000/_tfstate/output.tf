# ==========================================================================
#  888899990000 - TFState: output.tf
# --------------------------------------------------------------------------
#  Description
...
output "dynamodb_table_arn" {
  ...
  value       = module.tfstate.dynamodb_table_arn
}
...
output "dynamodb_table_stream_arn" {
  ...
  value       = module.tfstate.dynamodb_table_stream_arn
}

output "dynamodb_table_stream_label" {
  description = "A timestamp, in ISO 8601 format of the Table Stream. Only available when var.stream_enabled is true"
  value       = module.tfstate.dynamodb_table_stream_label
}
...
output "s3_bucket_policy" {
  ...
  value       = module.tfstate.s3_bucket_policy
}

output "s3_bucket_domain_name" {
  description = "The domain name this bucket."
  value       = module.tfstate.s3_bucket_domain_name
}

output "s3_bucket_regional_domain_name" {
  description = "The regional domain name this bucket."
  value       = module.tfstate.s3_bucket_regional_domain_name
}
...
output "s3_bucket_lifecycle_configuration_rules" {
  ...
  value       = module.tfstate.s3_bucket_lifecycle_configuration_rules
}

output "s3_bucket_website_domain" {
  description = "The website domain this bucket."
  value       = module.tfstate.s3_bucket_website_domain
}

output "s3_bucket_website_endpoint" {
  description = "The website endpoint this bucket."
  value       = module.tfstate.s3_bucket_website_endpoint
}