...
resource "aws_iam_policy" "dci_poweruser_acess" {
  provider    = aws.destination
  name        = "devopscorner-poweruseraccess_${var.aws_account_id_destination}_${var.workspace_env[local.env]}"
  path        = "/"
...
resource "aws_iam_policy" "dci_iamfull_acess" {
  provider    = aws.destination
  name        = "devopscorner-iamfullaccess_${var.aws_account_id_destination}_${var.workspace_env[local.env]}"
  path        = "/"
